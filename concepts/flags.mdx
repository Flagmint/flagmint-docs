...
<Note>
  After creation, you can adjust variant values, weights, and targeting rules. The template gives you a working starting point — customize it to match your experiment design. To measure which variant wins, see [Measuring A/B outcomes](/concepts/measuring-ab-outcomes).
</Note>
